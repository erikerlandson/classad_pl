...
test('select 2') :-
    parse("[a = [b=[c=42;];];]", C),
    eval_native("a.b.c", C, R),
    R == 42.

test('select 3') :-
    parse("[a = [b=[c=42;];];]", C),
    eval_native("a.z.c", C, R),
    R == undefined.
...
test('is isnt 1') :-
    eval_native("error is error", [], true),
    eval_native("error isnt error", [], false),
    eval_native("undefined is undefined", [], true),
    eval_native("undefined isnt undefined", [], false),
    eval_native("true is true", [], true),
    eval_native("true isnt true", [], false),
    eval_native("false is false", [], true),
    eval_native("false isnt false", [], false),
    eval_native("error is undefined", [], false),
    eval_native("error isnt undefined", [], true),
    eval_native("error is undefined", [], false),
    eval_native("error isnt undefined", [], true),
    eval_native("true is undefined", [], false),
    eval_native("false isnt undefined", [], true).

test('is isnt 2') :-
    eval_native("\"z\" is \"z\"", [], true),
    eval_native("\"z\" isnt \"z\"", [], false),
    eval_native("\"Z\" is \"z\"", [], false),
    eval_native("\"z\" isnt \"Z\"", [], true).

test('is isnt 3') :-
    eval_native("abstime(\"2012-02\") is abstime(\"2012-02\")", [], true),
    eval_native("abstime(\"2012-02\") isnt abstime(\"2012-02\")", [], false),
    eval_native("abstime(\"2012-03\") is abstime(\"2012-02\")", [], false),
    eval_native("abstime(\"2012-02\") isnt abstime(\"2012-03\")", [], true).

test('is isnt 4') :-
    eval_native("reltime(\"1\") is abstime(\"1\")", [], true),
    eval_native("reltime(\"1\") isnt abstime(\"1\")", [], false),
    eval_native("reltime(\"1\") is abstime(\"2\")", [], false),
    eval_native("reltime(\"2\") isnt abstime(\"1\")", [], true).

test('is isnt 5') :-
    eval_native("42 is 42", [], true),
    eval_native("42 isnt 42", [], false),
    eval_native("69 is 42", [], false),
    eval_native("42 isnt 69", [], true).

test('is isnt 6') :-
    eval_native("42.0 is 42.0", [], true),
    eval_native("42.0 isnt 42.0", [], false),
    eval_native("69.0 is 42.0", [], false),
    eval_native("42.0 isnt 69.0", [], true).

test('is isnt 7') :-
    eval_native("42 is 42.0", [], false),
    eval_native("42.0 isnt 42", [], true).

test('is isnt 8') :-
    eval_native("{0} is {0}", [], true),
    eval_native("{0} isnt {0}", [], false),
    eval_native("{0} is {1}", [], false),
    eval_native("{0} isnt {1}", [], true).

test('is isnt 9') :-
    eval_native("[a=4] is [a=4]", [], true),
    eval_native("[a=4] isnt [a=4]", [], false),
    eval_native("[b=4] is [a=4]", [], false),
    eval_native("[b=4] isnt [a=4]", [], true).
